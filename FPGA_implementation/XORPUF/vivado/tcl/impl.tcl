...
set DESIGN_TOP "iXOR_APUF_64_DOLUT_wrapper"

# report area utilization
report_utilization -hierarchical -hierarchical_depth 1 -file "${DESIGN_NAME}.txt"
#report_utilization -hierarchical -hierarchical_depth 2 -cells u_pulpino -file pulpino.txt

report_timing_summary -file "${DESIGN_NAME}_timing_summary.txt"
report_timing         -file "${DESIGN_NAME}_timing.txt"         -max_paths 10

# output Verilog netlist + SDC for timing simulation
write_verilog -force -mode timesim -cell "${DESIGN_TOP}" "./${DESIGN_TOP}.v"
write_sdf     -force -cell "${DESIGN_TOP}" "./${DESIGN_TOP}.sdf"
